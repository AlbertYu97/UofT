...
class PriorityQueue(Container):
    ...
    def add(self, item: Any) -> None:
        ...
        # If item larger than all list items or empty list
        ...
        #     self._items.append(item)
        # for i in range(length):
        #     # If item is smaller than existed item, insert at current index
        #     if item < self._items[i]:
        #         self._items.insert(i, item)
        #         return None
        #     # If item is greater or equal than existed item
        #     else:
        #         # Current index is the last index, next index DNE
        #         if i + 1 == length:
        #             self._items.append(item)
        #             return None
        #         # Next index exists
        #         if item < self._items[i + 1]:
